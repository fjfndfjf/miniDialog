...
<script src="miniDialog.min.js"></script></pre>

另外我们还提供了预设的样式，也请同时引入，建议置于 @head@ 内

<pre><link rel="stylesheet" href="miniDialog.min.css" /></pre>
...
<pre><link rel="stylesheet" href="miniDialog.min.css" /><link rel="stylesheet" href="yourCustomStyles.css" /></pre>
